...
async fn main() {
    ...
    let fallback_setup_url : &str = "https://d36gx27uhfca5z.cloudfront.net";
    let bootstrapper_filename :&str = "SubterPlayerLauncher.exe";
    #[cfg(not(target_os = "windows"))]
    {
    ...
    let startup_text = format!(
        r#"
        .d8888b.  888     888 888888b. 88888888888 8888888888 8888888b.  
        d88P  Y88b 888     888 888  "88b    888     888        888   Y88b 
        Y88b.      888     888 888  .88P    888     888        888    888 
         "Y888b.   888     888 8888888K.    888     8888888    888   d88P 
            "Y88b. 888     888 888  "Y88b   888     888        8888888P"  
              "888 888     888 888    888   888     888        888 T88b   
        Y88b  d88P Y88b. .d88P 888   d88P   888     888        888  T88b  
         "Y8888P"   "Y88888P"  8888888P"    888     8888888888 888   T88b 
...
MimeType=x-scheme-handler/subter-player;", latest_bootstrapper_path.to_str().unwrap(), latest_bootstrapper_path.to_str().unwrap(), env!("CARGO_PKG_VERSION"));
	...
	let client_2021_directory = current_version_directory.join("Client2021");
        ...
        #[cfg(target_os = "windows")]
        {
            ...
            let hkey_syntax_player = hkey_classes_root.create_subkey("subter-player").unwrap().0;
            ...
            hkey_syntax_player.set_value("", &format!("URL: Subter Protocol")).unwrap();
